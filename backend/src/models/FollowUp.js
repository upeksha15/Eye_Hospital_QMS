...
const followUpSchema = new mongoose.Schema(
  {
    ...
    patientRescheduled: { type: Boolean, default: false },
    patientRescheduledDate: { type: Date, required: false },
    patientAppointmentId: { type: mongoose.Schema.Types.ObjectId, ref: 'Appointment', required: false },
