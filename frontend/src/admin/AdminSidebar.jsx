    ...
    <aside className="w-72 min-h-screen flex flex-col bg-admin-navy text-white shrink-0 font-admin shadow-xl">
      ...
      <div className="p-4 mx-4 mt-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
        ...
        <button
          ...
          className="mt-3 w-full inline-flex items-center justify-center gap-2 rounded-lg border border-blue-300/30 bg-[#007bff]/20 px-3 py-2 text-xs font-semibold text-blue-100 hover:bg-[#007bff]/35 transition-colors"
        >
